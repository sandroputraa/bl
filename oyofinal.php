...
---------------------------------------------------------------------------------
   ...
   ______  ______     __________  ____  __   _____    ____  ___   ________ __
  / __ \ \/ / __ \   /_  __/ __ \/ __ \/ /  / ___/   / __ \/   | / ____/ //_/
 / / / /\  / / / /    / / / / / / / / / /   \__ \   / /_/ / /| |/ /   / ,<   
/ /_/ / / / /_/ /    / / / /_/ / /_/ / /______/ /  / ____/ ___ / /___/ /| |  
\____/ /_/\____/    /_/  \____/\____/_____/____/  /_/   /_/  |_\____/_/ |_|  
                                                                             
                    [#] CODE BY @sandro.putraa [#]
                           Thanks to SGB TEAM
---------------------------------------------------------------------------------
1. Auto Register + Reff ( Nama Indo ) ( Jangan lupa edit Reff di Line 122)
2. Checker No Terdaftar di OYO
Select Features: ";
$menu = trim(fgets(STDIN));
}while($menu!=1 AND $menu!=2);
if($menu==1){
     while(1){
      //Auto Register + Reff ( Nama Indo )
     // @sandro.putraa
...
function register($jumlah, $wait){
    ...
    while($x < $jumlah) {
        ...
        foreach(explode(PHP_EOL, file_get_contents($filephone)) as $a => $phoneNumber)
        {
                ...
                sleep(1);
                echo "\033[1;34m[#Sleep dulu.#]\033\n";
                sleep(10);
                echo "\033[1;35m[#Sleep dulu..#]\033\n";
                sleep(10);
                echo "\033[1;36m[#Gas Bosku...#]\033\n";
                                $asww = $phoneNumber;
  $ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://api.oyorooms.com/v2/users/generate_otp?phone='.$asww.'&nod=4&intent=login&sms_auto_retrieval=true&country_code=%2B62&version=20205&partner_app_version=20205&android_id='.generateRandomString(16).'&idfa=&sid=1551940465205');
...
if($json->is_user_present == 1){
    echo "\033[41m[# Nomor Sudah Terdaftar #]".$asww."\033[0m[->]\n";
}
$json = json_decode($result);
if($json->is_user_present == 0){
    echo "\033[42m[# Nomor Asiapp Digasss #]".$asww."\033[0m[->]\n";
echo 'Enter OTP : '; 
...
curl_setopt($ch, CURLOPT_POSTFIELDS, '{
    ...
    "device_type": "android",
    "email": "'.randomNama().generateRandomString(7).'@gmail.com",
    "id": 0,
    "idfa": "",
    "name": "'.randomNama().generateRandomString(5).'",
    "phone": "'.$asww.'",
    "push_type": "gcm",
    "referral_code": "SANDGJ746",
...
$mpsh = "Berhasil";
$ahhh = "Mendaftar OYO";
echo $json->phone."\033[".randomColors()."m".$mpsh."\033[0m => \033[".randomColors()."m".$ahhh."\033[0m\n";
}
...
$execute = register('100000', '15');
print $execute;

     }
}else if($menu==2){
    // Checker No Terdaftar di OYO
    // @sandro.putraa
    function generateRandomString($length = 10) {
    $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
    $charactersLength = strlen($characters);
